...
Структура html страницы
            ...
            <div className="col-12 col-md-6 ml-md-auto mt-4 mt-md-0">
              <p className="lead">
Каждый HTML-документ состоит из дерева HTML-элементов и текста. Элементы, находящиеся внутри тега
                <kbd>&lt;html&gt;</kbd>
, образуют дерево документа, так называемую объектную модель документа, DOM (document object model). При этом элемент
                <kbd>&lt;html&gt;</kbd>
                {' '}
...
Блочные и строчные элементы
            ...
            <div className="col-12 col-md-6 ml-md-auto mt-4 mt-md-0">
              <p className="lead">
                ...
                {' '}
представляет собой прямоугольник, который по умолчанию занимает всю доступную ширину страницы (если иное значение не указано в CSS), а длина элемента зависит от его содержимого. Такой элемент всегда начинается с новой строки, то есть, располагается под предыдущим элементом. Блочный элемент может содержать в себе другие блочные и строчные элементы.
                <br />
        ...
        <div className="container">
          <div className="row justify-content-center">
            ...
            <div className="col-12 col-sm-10 col-md-8 col-lg-6 text-center">
              ...
              <h5>
                <a target="_blank" href="https://getbootstrap.com/docs/4.0/content/tables/" rel="noopener noreferrer">
                  <i className="fa fa-external-link-square p-r" aria-hidden="true" />
